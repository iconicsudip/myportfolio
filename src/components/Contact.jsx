                        ...
                        <div className="contact-about-area">
                            ...
                            <div className="social-area">
                                ...
                                <div className="social-icone">
                                    ...
                                    <a href="https://www.linkedin.com/in/sudipdas80/" target='_blank'><iconify-icon icon="simple-icons:leetcode" width="24" height="24" style={{"color": "#c4cfde"}}></iconify-icon></a>
